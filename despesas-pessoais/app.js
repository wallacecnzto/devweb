    ...
    validarDados() {
        for (let i in this) {
            if (this[i] == undefined || this[i] == '' || this[i] == null) {
                return false //para sair da execução tipo break
            }
        }
        return true
    }
...
class Bd {
    ...
    recuperarTodosOsRegistros() {
        ...
        for (let i = 1; i <= id; i++) {
            ...
            //verificando se itens foram removidos(null) e pulando eles casos existam.
            if (despesa === null) {
                continue
            }
...
function cadastrarDespesa() {
    ...
    if (despesa.validarDados()) {
        ...
        document.getElementById('modal_conteudo')
            .innerHTML = 'Erro na gravação, verifique se todos os campos foram preenchidos'
